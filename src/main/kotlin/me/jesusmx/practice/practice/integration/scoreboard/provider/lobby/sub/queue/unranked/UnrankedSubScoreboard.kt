package me.jesusmx.practice.practice.integration.scoreboard.provider.lobby.sub.queue.unranked
...
class UnrankedSubScoreboard : SubScoreboard<MatchQueueEntry>() {
    ...
    override fun accept(player : Player, scores : MutableList<String>, entry : MatchQueueEntry) {
        scores.addAll(
            CC.translate(PotPvPSI.instance.scoreboardConfig.getStringList("IN-LOBBY-UNRANKED-QUEUE").stream()
