...
object Reflections {
    ...
    public val GAME_PROFILE_CLASS_LEGACY: Class<*>? = getClass("net.minecraft.util.com.mojang.authlib.GameProfile")
    public val GAME_PROFILE_CLASS: Class<*>? = getClass("com.mojang.authlib.GameProfile")
