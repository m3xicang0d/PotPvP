...
object TimeUtils {
    ...
    public val mmssBuilder: ThreadLocal<StringBuilder> = ThreadLocal.withInitial { java.lang.StringBuilder() }
    public val dateFormat: SimpleDateFormat = SimpleDateFormat("MM/dd/yyyy HH:mm")
