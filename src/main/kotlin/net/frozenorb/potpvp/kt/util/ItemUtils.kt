...
object ItemUtils {
    ...
    public val craftItemStack = Reflections.getCBClass("inventory.CraftItemStack")!!
    public val asNmsCopyMethod = Reflections.getMethod(craftItemStack, "asNMSCopy", ItemStack::class.java)
    public val nameMap: MutableMap<String, ItemData> = HashMap()
    ...
    class ItemBuilder constructor(public var type: Material?) {
        public var amount: Int = 0
        public var data: Short = 0
        public var name: String? = null
        public var lore: MutableList<String>? = null
