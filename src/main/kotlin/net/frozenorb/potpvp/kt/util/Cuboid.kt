...
class Cuboid : Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    val world: World
        get() =
            PotPvPSI.instance.server.getWorld(worldName)
    ...
    public constructor(worldName: String, x1: Int, y1: Int, z1: Int, x2: Int, y2: Int, z2: Int) {
    ...
    inner class CuboidIterator(public val w: World, x1: Int, y1: Int, z1: Int, x2: Int, y2: Int, z2: Int) : Iterator<Block> {
        public val baseX: Int
        public val baseY: Int
