package net.frozenorb.potpvp.kt.morpheus.game.event.impl.skywars.loot
...
object SkywarsGameEventLootUtils {
    ...
    public fun containsType(inventory: Inventory, type: String): Boolean {
    ...
    public fun containsType(inventory: List<ItemStack?>, type: String): Boolean {
    ...
    public fun getType(itemStack: ItemStack): String {
    ...
    public fun getTier(itemStack: ItemStack): Int {
        var toReturn = 0
    ...
    public fun isBetter(first: ItemStack, second: ItemStack): Boolean {
        var firstLevels = 0
