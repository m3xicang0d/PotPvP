...
import net.frozenorb.potpvp.kt.morpheus.game.event.impl.sumo.SumoGameEventLogic
...
object BracketsGameEvent : GameEvent {
    ...
    public const val NAME = "Brackets"
    public const val PERMISSION = "practice.host.skywars"
    public const val DESCRIPTION = "Compete against other players in brackets."
