...
import net.frozenorb.potpvp.player.party.listener.PartyChatListener;
import net.frozenorb.potpvp.player.party.listener.PartyItemListener;
import net.frozenorb.potpvp.player.party.listener.PartyLeaveListener;
...
public final class PartyHandler {
    ...
    public final Set<Party> parties = Collections.newSetFromMap(new ConcurrentHashMap<>());
    public final Map<UUID, Party> playerPartyCache = new ConcurrentHashMap<>();
