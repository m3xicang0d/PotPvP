package net.frozenorb.potpvp.player.elo.repository;
...
public final class MongoEloRepository implements EloRepository {
    ...
    public static Map<String, Map<String, Integer>> cachedFormattedElo = Maps.newHashMap();
    public static MongoEloRepository instance;
    ...
    public void refreshFormattedElo() {
