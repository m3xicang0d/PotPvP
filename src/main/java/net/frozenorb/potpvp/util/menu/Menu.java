...
public abstract class Menu {
    ...
    private Inventory createInventory(Player player) {
        ...
        final Inventory inventory = PotPvPSI.getInstance().getServer().createInventory(player, size(player), getTitle(player));
    ...
    private void update(Player player) {
        ...
        runnable.runTaskTimer(PotPvPSI.getInstance(), 10L, 10L);
