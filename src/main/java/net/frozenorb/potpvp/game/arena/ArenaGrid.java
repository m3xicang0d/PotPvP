...
public final class ArenaGrid {
    ...
    @Getter public boolean busy = false;
    ...
    public void createArenas(ArenaSchematic schematic, int currentCopies, int toCreate, Runnable callback) {
        ArenaHandler arenaHandler = PotPvPSI.getInstance().getArenaHandler();
    ...
    public void deleteArenas(ArenaSchematic schematic, int currentCopies, int toDelete, Runnable callback) {
        ArenaHandler arenaHandler = PotPvPSI.getInstance().getArenaHandler();
    ...
    public Arena createArena(ArenaSchematic schematic, int xStart, int zStart, int copy) {
