...
public final class SelectKiToEditMenu extends Menu {

    public final boolean reset;
    public final Callback<KitType> callback;
    private final String tt;

    public SelectKiToEditMenu(Callback<KitType> callback, String title) {
        this(callback, true, title);
    }

    public SelectKiToEditMenu(Callback<KitType> callback, boolean reset, String title) {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        for (KitType kitType : KitType.getAllTypes()) {
            ...
            //A eso voy xd
            if(kitType.isHidden() && !(kitType.equals(bard) || kitType.equals(diamond) || kitType.equals(archer)) && !player.isOp()) {
                continue;
            }
