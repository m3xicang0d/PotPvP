...
public final class PostMatchInvHandler {
    ...
    public final Map<UUID, Map<UUID, PostMatchPlayer>> playerData = new ConcurrentHashMap();
    ...
    public void writeTeamInvMessages(Iterable<MatchTeam> teams, Map<UUID, Object[]> messageMap, Object[] messages) {
        for (MatchTeam team : teams) {
            writeTeamInvMessages(team, messageMap, messages);
        }
    }

    public void writeTeamInvMessages(MatchTeam team, Map<UUID, Object[]> messageMap, Object[] messages) {
    ...
    public void writeSpecInvMessages(Match match, Map<UUID, Object[]> messageMap, Object[] messages) {
        for (UUID spectator : match.getSpectators()) {
