...
import net.frozenorb.potpvp.game.pvpclasses.event.BardRestoreEvent;
...
public class PvPClassHandler extends BukkitRunnable implements Listener {
    ...
    @Getter public static Map<String, PvPClass> equippedKits = new HashMap<>();
    @Getter public static Map<UUID, PvPClass.SavedPotion> savedPotions = new HashMap<>();
